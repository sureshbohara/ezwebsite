              ...
              <a class="dropdown-item" href="#">
                <div class="d-flex align-items-center">
                  ...
                  <div class="ms-3 flex-grow-1">
                    <h6 class="mb-0 dropdown-msg-user">test name <span class="msg-time float-end text-secondary">22.33 m</span></h6>
                    <small class="mb-0 dropdown-msg-text text-secondary d-flex align-items-center">test message</small>
                  </div>
                </div>
              </a>
            </div>

<div class="modal fade" id="sendAllCustomerMail" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <form  action="{{route('mail.send.user')}}" method="post" enctype="multipart/form-data">@csrf

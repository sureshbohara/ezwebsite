...
@section('main_title', 'Review Website')
...
<main class="page-content">
  ...
  <div class="card">
    <div class="card-header bg-custom d-flex align-items-center justify-content-between">
      <h6 class="mb-0 text-light">Review List</h6>
      <a class="mb-0 btn btn-default btn-sm" href="#" type="button" data-bs-toggle="offcanvas" data-bs-target="#review" aria-controls="offcanvasRight">
        <i class="fa fa-plus-circle"></i> Create New Review
      </a>

...
@section('main_title', 'Gallery Website')
...
<main class="page-content">
  ...
  <div class="card">
    <div class="card-header bg-custom d-flex align-items-center justify-content-between">
      <h6 class="mb-0 text-light">Gallery List</h6>
      <a class="mb-0 btn btn-default btn-sm" href="#" type="button" data-bs-toggle="offcanvas" data-bs-target="#gallery" aria-controls="offcanvasRight">
